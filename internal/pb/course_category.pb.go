...
type CategoryResponse struct {
	...
	Category *Category `protobuf:"bytes,1,opt,name=category,proto3" json:"category,omitempty"` //Essa response é do tipo "Category", que foi definido acima.
}
...
type CategoryList struct {
	...
	Categories []*Category `protobuf:"bytes,1,rep,name=categories,proto3" json:"categories,omitempty"` //Receberemos várias "Category". É como se fosse uma lista, que é definida pela palavra-chave "repeated".
}
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x61, 0x6e, 0x6b, 0x22, 0x3c, 0x0a, 0x10,
	...
	0x52, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x3c, 0x0a, 0x0c, 0x43, 0x61,
	...
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x4d, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61,
	...
	0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xd0, 0x01, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65,
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 2: pb.CategoryService.CreateCategory:input_type -> pb.CreateCategoryRequest
	4, // 3: pb.CategoryService.CreateCategoryStream:input_type -> pb.CreateCategoryRequest
	1, // 4: pb.CategoryService.ListCategories:input_type -> pb.blank
	2, // 5: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
